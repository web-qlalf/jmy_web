            ...
            <body>
              ...
              <?php $this->lang->load('headtag_lang', 'korean'); ?>
                      			...
                      			<div class="top-bar">
                      				<div class="container">
                      						...
                      						<div class="col-xl-8 col-lg-8 col-sm-4 col-7">
                      							<div class="top-bar-left d-flex">
                      								<div class="clearfix">
                      									<ul class="socials">
                                          <li>
                                            <a class="social-icon text-dark" href="/"><span>JMY</span></a>
                                          </li>
                      										<li>
                                        ...
                                        if($this->session->userdata('logged_in') && !$this->session->userdata('admin'))
                                        {
                                          ?>
                                        <li>
                        										<a href="/mypage" class="text-dark"><i class="fa fa-user-circle mr-1"></i> <span><?=$this->session->userdata('user_name')?>님 </span></a>
                        								</li>
                                        <li>
                        										<a href="/cart" class="text-dark"><i class=" fa fa-shopping-cart mr-1"></i> <span>장바구니</span></a>
                        								</li>
                                        <li>
                        										<a href="/wishlist" class="text-dark"><i class="fa fa-heart-o mr-1"></i> <span>찜목록</span></a>
                        								</li>
                                        <li>
                                      ...
                                      else if($this->session->userdata('logged_in') && $this->session->userdata('admin'))
                                      {
                                      ?>
                                      <li>
                                          <a href="/admin/user/detail/<?=$_SESSION['user_no']?>" class="text-dark"><i class="fa fa-user-circle mr-1"></i> <span><?=$this->session->userdata('user_name')?>님 </span></a>
                                      </li>
                                      <li>
                                          <a href="/admin" class="text-dark"><i class="fa fa-sing-out mr-1"></i> <span>대시보드</span></a>
                                      </li>
                                      <li>
                                          <a href="/logout" class="text-dark"><i class="fa fa-sing-out mr-1"></i> <span>로그아웃</span></a>
                                      </li>
                              ...
                              <!--dashboard.css 677줄 960px에서 992로 수정-->
                                    ...
                                    ?>
                                    <li aria-haspopup="true"><a href="/category/<?=$middle_category_no?>"><?=$middle_category_name?></a></li>
                                    <?php
                                      }
                                    }
                                    ?>
