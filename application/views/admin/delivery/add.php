<div class="row row-cards">
  <div class="col-md-12">
    <form action="/admin/delivery/addInfo" method="POST">
      <div class="card">
        <div class="card-header">
          <div class="card-title"><b>배송지 추가</b></div>
        </div>
        <div class="card-body">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9 mb-2">
                <input type="text" class="form-control w-100 shipping_name" maxlength="20" placeholder="배송지 이름" id="shipping_name" name="shipping_name" onblur="checkText(this.id,5)" required/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="row">
                  <div class="col-md-10">
                    <input type="text" class="form-control w-100" id="zipcode" name="zipcode" value=""   placeholder="우편번호" required readonly/>
                  </div>
                  <div class="col-md-2">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="adress1" name="adress1" value=""   placeholder="주소" required readonly/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="adress2" name="adress2" value=""   placeholder="상세주소"/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="adress3" name="adress3" value=""   placeholder="참고항목"/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="delivery_company" name="delivery_company" value="" onblur="checkText(this.id,5)" placeholder="택배사" required/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="delivery_fee1" name="delivery_fee1" value="" onblur="checkText(this.id,2)" placeholder="편도배송비" required/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="delivery_fee2" name="delivery_fee2" value="" onblur="checkText(this.id,2)" placeholder="왕복배송비" required/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                  <input type="text" class="form-control w-100" id="memo" name="memo" value=""   placeholder="비고"/>
              </div>
            </div>
          </div>
        </div>
